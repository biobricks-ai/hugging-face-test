<h1 align="center">Public Biobricks Chat AI</h1>
...
| Pubmed Central | PubMed Central® (PMC) is a free full-text archive of biomedical and life sciences journal literature at the U.S. National Institutes of Health | https://github.com/biobricks-ai/pmc | | |
| ClinVar | ClinVar aggregates information about genomic variation and its relationship to human health | https://github.com/biobricks-ai/clinvar | | |
| Database Gap | Results from studies that have investigated the interaction of genotype and phenotype in humans | https://github.com/biobricks-ai/dbgap | | |
| DB SNP | The Single Nucleotide Polymorphism Database | https://github.com/biobricks-ai/dbsnp | | |
| Chembl | Manually curated database of bioactive molecules with drug-like properties | https://github.com/biobricks-ai/chembl | | |
| OpenAlex | OpenAlex is a free index of the world's research ecosystem. It's made by OurResearch with support from Arcadia  | https://github.com/biobricks-ai/openalex | |
| CP DB| carcinogencity potency database  | https://github.com/biobricks-ai/cpdb | | |
| Gene Ontology | The Gene Ontology (GO) knowledgebase is the world’s largest source of information on the functions of genes  | https://github.com/biobricks-ai/geneontology | | |
| Chebirdf | Relational data format for Chebi - Dictionary of molecular entities from products of nature or synthetic products | https://github.com/biobricks-ai/chebirdf | | |
| CPDAT | 49k chemicals categorized by usage or function in 16k consumer products (e.g. shampoo, soap) | https://github.com/biobricks-ai/cpdat | | |
| Comptox | | https://github.com/biobricks-ai/comptox | | |
| Pharmgkb | The Pharmacogenomics Knowledge Base | https://github.com/biobricks-ai/pharmgkb | | |
| Pubchemrdf-kg | The PubChem Compound, Substance, BioAssay databases in RDF format. | https://github.com/biobricks-ai/pubchemrdf-kg | | |
| Pubmed | PubMed® comprises more than 34 million citations for biomedical literature | https://github.com/biobricks-ai/pubmed | | |
| Ctdbase-kg | | https://github.com/biobricks-ai/ctdbase-kg | | |
| HPO | The Human Phenotype Ontology (HPO) provides a standardized vocabulary of phenotypic abnormalities encountered in human disease | https://github.com/biobricks-ai/hpo | | |
| Pubchemrdf | Relational data format for PubChem - a database of chemical molecules and their activities against biological assays | https://github.com/biobricks-ai/pubchemrdf | | |
| 1000genomes | The 1000 Genomes Project created a catalogue of common human genetic variation, using openly consented samples | https://github.com/biobricks-ai/1000genomes | | |
| CPCat | 43,000 chemicals categorized to product usage or function compiled from publically available sources | https://github.com/biobricks-ai/cpcat | | |
| Pubchemghs | Globally Harmonized System of Classification and Labeling of Chemicals | https://github.com/biobricks-ai/pubchemghs | | |
| Uniprot | UniProt is a freely accessible database of protein sequence and functional information | https://github.com/biobricks-ai/uniprot | | |
...
| UMLS | The UMLS integrates and distributes key terminology, classification and coding standards, and associated resources | https://github.com/biobricks-ai/umls | | | 
